...
@if(\Auth::guard('admin')->user()->image_name == 'default.jpg')
  <?php   $image  = 'Assets/images/default.jpg'; ?>
    @else
    <?php   $image  = '/image/'.\Auth::guard('admin')->user()->image_name; ?>          
    @endif
...
<i class="fa-solid fa-pen-to-square"></i>
 ...
 <div
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="container">
                        ...
                        <form action="{{url('updateprofile',\Auth::guard('admin')->user()->id)}}" method="post" enctype="multipart/form-data">
                          <!-- acount img -->
                          @csrf
                        <div class="row mx-auto d-flex flex-row">
                          ...
                          >
                            <span class="fw-semibold fs-6">{{\Auth::guard('admin')->user()->name}}</span>
            ...
            <!-- #cheangePass{{\Auth::guard('admin')->user()->id}} -->

            <!-- editprofileadmin{{\Auth::guard('admin')->user()->id}} -->


            <!-- {{url('updateprofile',\Auth::guard('admin')->user()->id)}} -->
