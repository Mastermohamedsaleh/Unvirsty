...
<i class="fa-solid fa-pen-to-square"></i>
 ...
 <div
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="container">
                        ...
                        <form action="{{url('updateprofile',\Auth::guard('student')->user()->id)}}" method="post" enctype="multipart/form-data">
                          <!-- acount img -->
                          @csrf
                        <div class="row mx-auto d-flex flex-row">
                          ...
                          >
                            <span class="fw-semibold fs-6">{{\Auth::guard('student')->user()->name}}</span>
                            <span class="txt-green">{{\Auth::guard('student')->user()->college->name}}</span>
                            <div class="w-auto">
            ...
            <!-- #cheangePass{{\Auth::guard('student')->user()->id}} -->

            <!-- editprofilestudent{{\Auth::guard('student')->user()->id}} -->


            <!-- {{url('updateprofile',\Auth::guard('student')->user()->id)}} -->
