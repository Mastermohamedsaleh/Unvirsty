...
<section class="vh-100" style="background-color: #f4f5f7;">
 ...
 <button type="button" class="btn btn-light" data-bs-toggle="modal" data-bs-target="#editprofiledoctor{{\Auth::guard('doctor')->user()->id}}">
 <i class="far fa-edit mb-5"></i>
            ...
            <div class="col-md-8">
              <div class="card-body p-4">
                ...
                <a href="#"  type="button" class="btn btn-light" data-bs-toggle="modal" data-bs-target="#cheangePass{{\Auth::guard('doctor')->user()->id}}">Change Password</a>
...
<div class="modal fade" id="editprofiledoctor{{\Auth::guard('doctor')->user()->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="post"  action="{{route('updatedoctorprofile',\Auth::guard('doctor')->user()->id)}}" autocomplete="off" enctype="multipart/form-data">
      @csrf
      <div class="row">
      <div class="col-12">
