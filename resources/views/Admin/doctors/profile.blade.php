...
@if(\Auth::guard('doctor')->user()->image_name == 'default.jpg')
  <?php   $image  = 'Assets/images/default.jpg'; ?>
    @else
    <?php   $image  = '/image/'.\Auth::guard('doctor')->user()->image_name; ?>          
    @endif
...
<i class="fa-solid fa-pen-to-square"></i>
 ...
 <div
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="container">
                        ...
                        <form action="{{url('updateprofile',\Auth::guard('doctor')->user()->id)}}" method="post" enctype="multipart/form-data">
                          <!-- acount img -->
                          @csrf
                        <div class="row mx-auto d-flex flex-row">
                          ...
                          >
                            <span class="fw-semibold fs-6">{{\Auth::guard('doctor')->user()->name}}</span>
                            <span class="txt-green">{{\Auth::guard('doctor')->user()->college->name}}</span>
                            <div class="w-auto">
                              <input type="hidden" name="email" value="{{\Auth::guard('doctor')->user()->email}}" >
                              <input type="hidden" name="name" value="{{\Auth::guard('doctor')->user()->name}}" >
                              <button
                              name="action"
                                type="submit"
            ...
            <!-- #cheangePass{{\Auth::guard('doctor')->user()->id}} -->

            <!-- editprofiledoctor{{\Auth::guard('doctor')->user()->id}} -->


            <!-- {{url('updateprofile',\Auth::guard('doctor')->user()->id)}} -->
